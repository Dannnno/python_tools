...
usage = """
USAGE: 
    >> python to_blockdiag.py output_file [, input_file]
"""
        
if len(sys.argv) not in [2, 3]:
    raise Exception(usage)
    
directory = "C:/Users/Dan/Desktop/Programming/Python/BlockDiag/"
output_file_name = directory + sys.argv[1]
